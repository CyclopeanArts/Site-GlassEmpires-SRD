---
title: Minor Powers
tags: [lore, factions, minor-powers, worldbuilding]
draft: true
summary: "Gods of Glass, Imperial Family, Papermark, Theomni, Kain & the Oropolis, Mountain Imps. The secondary players and wildcards."
author: Histoire
status: draft
date: 2026-05-05
---
...
<Callout type="gm" heading="Design Note">
Wrap this into the Main Scenario text.
</Callout>
...
Unlike the major factions (p. @), minor powers are defined by a disinterest in the *conquest* of Glass. They may be suitable as allies, obstacles, or wildcards in a campaign.
