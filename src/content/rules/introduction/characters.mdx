...
Characters act by making **Moves** [[rules/moves|Moves]]. A Move is any action with uncertain or meaningful outcomes, whether that be swinging a sword, negotiating a treaty, or hunting a beast. When a Move's outcome is uncertain, the character makes a **Save** [[introduction/saves|Save]]: a 2d6 roll, modified by any relevant Facts, against a result table.
