...
| **Speeds** | How fast the character moves in each mode: Run, Fly, Swim, Dig. Measured in feet per round. | Set by Race, modified by Features and Conditions. |
...
Characters act by taking **Actions** [[actions|Actions]]. An Action is any undertaking with uncertain or meaningful outcomes, whether that be swinging a sword, negotiating a treaty, or hunting a beast. When an Action's outcome is uncertain, the character makes a **Save** [[saves|Save]]: a 2d6 roll, modified by any relevant Facts, against a result table.
