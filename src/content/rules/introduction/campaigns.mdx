...
A campaign consists of a **calendar** [[glossary/glossary-calendar|calendar]] & a **map** depicting the world or a region of the world in which the game takes place.

## Calendar

A **calendar** is required in order to keep track of Deadlines for Moves [[rules/moves|Moves]] & for synchronizing Players with the current state of the world.
...
- **Terrain types**, sufficiently distinct enough for the GM(s) to make rulings regarding what areas of the map qualify for which travel costs [[glossary/glossary-map|map]].
