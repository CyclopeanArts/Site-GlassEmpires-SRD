...
A campaign consists of a **calendar** & a **map** depicting the world or a region of the world in which the game takes place.

## Calendar

A **calendar** is required in order to keep track of Durations for [[actions|Actions]] & for synchronizing Players with the current state of the world.
