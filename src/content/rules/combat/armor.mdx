...
Armor reduces incoming Physical damage by its **Armor value**. A character's Armor value is determined by the best armor they are wearing.
...
AP is derived as **Armor × HD**. This represents the armor's structural capacity to absorb damage before it is compromised.
