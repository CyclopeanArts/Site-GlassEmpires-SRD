...
Horizontal jumps cover a number of feet equal to half the character's Run score on a running start, or one quarter standing still. Vertical jumps reach one quarter of those distances. Characters wearing heavy armor (chain or plate) halve all jumping distances.

### Swimming

Characters with a Swim speed move at that speed in water. Characters without a Swim speed move at half their Run score and must Save once per minute or begin drowning.
