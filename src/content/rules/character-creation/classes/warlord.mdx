...
|   8   | **Contractual Oath**: When you (or any forces you command) enter a fight where victory fulfills contractual obligations to an external party or to a greater shared cause, you *always* have the morale advantage (in [[battles\|Battles]]) & a +2 bonus on all Saves to avoid [[condition-panicked\|Panic]] or flight (in [[skirmishes\|Skirmishes]]). If your employer breaches the terms of a contract, you also gain this bonus while working to coerce, loot, or destroy them. |
